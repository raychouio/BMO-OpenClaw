...
name: cursor-agent
version: 1.1.0
description: A comprehensive skill for using the Cursor CLI agent for various software engineering tasks
---

# Cursor CLI Agent Skill

This skill provides a comprehensive guide and set of workflows for utilizing the Cursor CLI tool.
